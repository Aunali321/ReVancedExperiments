package li.auna.patches.all.misc.resources
...
import li.auna.util.*
import li.auna.util.resource.ArrayResource
import li.auna.util.resource.BaseResource
import li.auna.util.resource.StringResource
...
) = li.auna.patches.all.misc.resources.resources.getOrPut(value, ::mutableSetOf).addAll(resources)
